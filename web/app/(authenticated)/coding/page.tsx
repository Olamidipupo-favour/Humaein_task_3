...
import { Code, CheckCircle, AlertTriangle, Brain, FileText, Copy } from 'lucide-react'
...
export default function CodingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResult({ success: false, error: 'Failed to generate coding suggestions' })
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Get intelligent ICD-10 and CPT code suggestions</p>
      </div>
        ...
        >
          ...
          {!result ? (
            <div className="text-center py-8 text-gray-500">
              ...
              <p>Submit clinical information to get AI-powered coding suggestions</p>
            </div>
          ) : result.success ? (
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-6 h-6 text-green-500" />
                <span className="font-semibold text-green-700">Codes Generated</span>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-red-50 p-4 rounded-lg">
                <p className="text-red-700">{result.error || 'Failed to generate coding suggestions'}</p>
              </div>
            </div>
          )}
          </div>
