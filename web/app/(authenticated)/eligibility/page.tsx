  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/rcm/eligibility/check`,
        {
          method: "POST",
          headers: {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">
          Check patient insurance coverage and benefits
        </p>
      </div>
                ...
                {result.data?.prior_auth_required && (
                  <div className="bg-yellow-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-yellow-700 mt-1">
                      This service requires prior authorization before
                      treatment.
                    </p>
                  </div>
                )}
              ...
              <div className="space-y-4">
                ...
                <div className="bg-red-50 p-4 rounded-lg">
                  <p className="text-red-700">
                    {result.error || "Patient is not eligible for this service"}
                  </p>
                </div>
              </div>
            )}
