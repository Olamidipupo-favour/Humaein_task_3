...
export default function PriorAuthPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://145.223.88.159:8000/rcm/prior-auth/draft', {
        method: 'POST',
        headers: {
      ...
      setResult({ success: false, error: 'Failed to generate prior authorization' })
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Generate prior authorization requests and letters</p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="durable_medical">Durable Medical Equipment</option>
          ...
          {!result ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="font-semibold text-green-700">Authorization Generated</span>
              </div>
              
              <div className="bg-green-50 p-4 rounded-lg">
                <h4 className="font-medium text-green-800 mb-2">Authorization Details</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>Authorization ID:</span>
                    <span className="font-medium">{result.data?.auth_id || 'PA-20241201-1234'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Status:</span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{result.data?.estimated_days || '3-5'} business days</span>
                  </div>
                </div>
              </div>

              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-medium text-blue-800 mb-2">Required Documentation</h4>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="font-semibold text-red-700">Generation Failed</span>
              </div>
              
              <div className="bg-red-50 p-4 rounded-lg">
                <p className="text-red-700">{result.error || 'Failed to generate prior authorization'}</p>
              </div>
            </div>
          )}
          </div>
